...
4. **Hand off to chittyagent-connect** for storage: ChittySecrets / Cloudflare Secrets Store, Cloudflare Worker Secret, GH repo secret. You produce; Concierge stores. Canonical separation.
